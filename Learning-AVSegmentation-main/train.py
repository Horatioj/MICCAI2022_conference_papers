    ...
    for epoch in range(epochs):
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                G_Loss = gama_hyper*loss_adv_G_fake + beta_hyper*loss_seg_CE + alpha_hyper*loss_seg_MSE #loss segmentation
                ...
                G_Loss = gama_hyper*loss_adv_G_fake + beta_hyper*loss_seg_CE + alpha_hyper*loss_seg_MSE + 1/2*(alpha_hyper*loss_seg_MSE_1 + beta_hyper*loss_seg_CE_1) + \
                    1/4*(alpha_hyper*loss_seg_MSE_2 + beta_hyper*loss_seg_CE_2) + 1/8*(alpha_hyper*loss_seg_MSE_3 + beta_hyper*loss_seg_CE_3)  #fusion loss
...
if __name__ == '__main__':
    ...
    net_G_A = Generator_branch(input_channels=3, n_filters = 32, n_classes=3, bilinear=False) #branch
